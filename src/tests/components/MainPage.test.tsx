...
describe("Main Page", () => {
    ...
    test("Renders product cards with name, price, colour and image", async () => {
        ...
        await waitFor (() => expect(within(screen.getByTestId("ProductCard-1")).getByAltText("Test dress 1")).toBeInTheDocument());
        expect(within(screen.getByTestId("ProductCard-1")).getByText("Test dress 1")).toBeInTheDocument();
