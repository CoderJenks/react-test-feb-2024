...
const SingleProductPage = () => {    
    ...
    return (
        <div className="SingleProductPage__Content">
            <h2 className="SingleProductPage__Header">
                Single Product Page
            </h2>
            {(product) ? (
                <div className="SingleProduct__Container">
                    <img className="SingleProduct__Image" src={product.img} alt={product.name} />
                    <div className="SingleProduct__ProductDetails" >
                        ...
                        <div className="SingleProduct__Price">Price: {new Intl.NumberFormat("en-GB", { style: "currency", currency: "GBP" }).format(product.price)}</div>
